...
public:
  ...
  std::string resolve(const std::string& inputCapability, const rapidjson::Document& payload) const;
...
private:
  ...
  static bool matchesCondition(const RouteCondition& cond, const rapidjson::Document& payload);
